      ...
      <Card title="Form Penjualan">
        ...
        <div className="grid">
          ...
          <div>
            ...
            <select
              ...
              style={{
                padding: "10px 12px",
                border: "1px solid #cbd5e1", // <-- sudah benar
                borderRadius: 8,
                width: "100%",
              }}
              disabled={loading}
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: 18, fontWeight: "bold", color: COLORS.success }}
            >
              {fmtIDR(total)}
            </span>
          </div>
        ...
        {/* Aksi */}
        <div
          style={{ display: "flex", gap: 12, justifyContent: "flex-end", marginTop: 12 }}
        >
