    ...
    <div>
      ...
      <Card title="Form Penjualan">
        {err && (
          <div
            style={{
              color: COLORS.danger, padding:12, background:`${COLORS.danger}15`,
              borderRadius:8, marginBottom:16, border:`1px solid ${COLORS.danger}30`
            }}
          >
            ⚠️ {err}
          </div>
        ...
        <form onSubmit={submit} className="grid" style={{opacity: loading? .7 : 1, pointerEvents: loading? 'none':'auto'}}>
          <div>
          ...
          <div style={{display:'flex', gap:12, justifyContent:'flex-end'}}>
            <Button type="button" onClick={loading?undefined:onCancel} className="secondary" disabled={loading}>Batal</Button>
